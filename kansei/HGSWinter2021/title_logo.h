...
// マクロ定義
#define T_LOGO_POS		(D3DXVECTOR3(300.0f, -1050.0f, 0.0f))			// ロゴの開始位置
#define T_LOGO_SIZE		(D3DXVECTOR2(400.0f, 150.0f))		// ロゴのサイズ
#define T_LOGO_SETPOS	(D3DXVECTOR3(630.0f, 180.0f, 0.0f))				// ロゴの最終地点
//#define COLOR_CNT		(50)
