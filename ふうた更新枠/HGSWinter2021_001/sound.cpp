...
CSound::PARAM CSound::m_aParam[CSound::SOUND_LABEL_MAX] =
{
	...
	{"data/BGM/stageSelect.wav", -1},	// BGM1(ステージセレクト)
	{"data/BGM/stage000.wav", -1},		// BGM2(ステージ0)
	{"data/BGM/stage001.wav", -1},		// BGM3(ステージ1)
	{"data/BGM/stage002.wav", -1},		// BGM4(ステージ2)
	{"data/BGM/result.wav", -1},		// BGM5(リザルト)
	{"data/BGM/ranking.wav", -1},		// BGM6(ランキング)
	{"data/SE/se_jump.wav", 0},			// ジャンプ音
	{"data/SE/select.wav", 0},			// セレクト音
	{"data/SE/selectok.wav", 0},		// 決定音
	...
	{"data/SE/title_enter.wav", 0},		// タイトルエンター
	{"data/SE/select_cursor.wav", 0},	// セレクトカーソル音
	{"data/SE/select_stage.wav", 0},	// ステージセレクト音
	{"data/SE/goal.wav", 0},			// ゴール音
	{"data/SE/gameclear.wav", 0},		// ファンファーレ
	{"data/SE/timer_warning.wav", 0},	// 残り時間警告
	{"data/SE/time_over.wav", 0},		// タイムオーバー
	{"data/SE/gameover.wav", 0},		// ゲームオーバー
	{"data/SE/earthquake.wav", 0},		// 足場揺れ
	{"data/SE/fall_sccaford.wav", 0},	// 足場落ちる
};
